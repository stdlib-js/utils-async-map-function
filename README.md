...
```javascript
import mapFunAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-map-function@v0.2.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-map-function@v0.2.0-esm/index.mjs';
```
